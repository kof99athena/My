...
class Tab1teamSalesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        salesitems.add(SalesItem(R.drawable.pro9,"김혜영","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"김민수","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"김지은","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"김형준","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"박지영","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"박준형","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"이채연","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"이준수","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"이현이","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"이주용","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"한지은","02-0222-2832"))
        salesitems.add(SalesItem(R.drawable.pro9,"한태윤","02-0222-2832"))
